    ...
    >
      <div className="p-4">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h1 className="text-[16px] font-bold text-[var(--text)]">Equipe</h1>
            <p className="text-[12px] text-[var(--muted)]">Projetos agrupados por área</p>
          </div>
        </div>
        ...
        <div className="bg-white border border-[var(--border)] rounded-lg p-14 text-center">
          ...
          <p className="text-[12px] text-[var(--muted)]">Os membros da equipe e áreas serão listados aqui.</p>
        </div>
      </div>
    </Layout>
  );
